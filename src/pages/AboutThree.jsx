...
import "../styles/aboutthree.css";

function aboutthree() {
    return (
        <div className="custom-wax-bg">
            {/* Hero / Lead */}
            <section className="aboutthree-hero">
                <h1>aboutthree Dominion Chemical</h1>
                <p>
            ...
            <section className="aboutthree-blurb-section" aria-label="Dominion Chemical Experience and Capabilities">
                <div className="aboutthree-blurb-card">
            ...
            <section className="aboutthree-main-section">
                <div className="aboutthree-content-card">
                    <h2>Our Services</h2>
                    <ul>
                        <li>
            ...
            <section className="custom-wax-footer-note aboutthree-footer-note">
                <p>
                    <em>
